...
const managementCommitteeRouter = require("./routes/managementCommitteeRoute");
// college development committee routes
...
app.use("/api/v1/management-committee", managementCommitteeRouter);
